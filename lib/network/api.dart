...
class Network {
  final String _url = 'http://127.0.0.1:8001/api'; // URL server API...  jika menggunakan port selain 8001 ubah disini linknyaa, pastikan menambahkan [ /api ] walaupun di chromenya gaada contoh https://localhost:8000/api
